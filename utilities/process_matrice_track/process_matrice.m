...
%dir(fullfile("C:\Users\ioste\OneDrive - Politecnico di ...
%Milano\PhD\projects\UAV SAR\dataset\20230713\drone track\" + ...
    
file_list = ...
    dir(fullfile("C:\Users\user\OneDrive - Politecnico di Milano\PhD\projects\UAV SAR\uav_bistatic_sar\mat_files\uav_test\20220826\drone track\raw\matrice\*.csv"));
...
%% Save static Transmitter
tx_pos.lat = mean(stable_gps.lat);
tx_pos.lon = mean(stable_gps.lon);
ENU  = lla2enu([tx_pos.lat, tx_pos.lon, lla0(3)],lla0,'flat');
tx_pos.X = ENU(1);tx_pos.Y = ENU(2); tx_pos.Z =  ENU(3);
save("tx_pos","tx_pos")    
